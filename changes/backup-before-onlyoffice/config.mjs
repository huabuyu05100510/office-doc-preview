...
const SAMPLES_DIR = path.resolve(ROOT, '..', 'files')      // office-doc-preview/files（正确路径）
...
export const CONFIG = {
  ...
  SAMPLES_DIR,
  SOFFICE: process.env.SOFFICE || '/Applications/LibreOffice.app/Contents/MacOS/soffice',
